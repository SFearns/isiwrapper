...
$ReportFileName=[string](Get-Date -Format yyyyMMdd)+"_"+[string](Get-Date -Format HHmmss)+" - $Cluster - SMB Configuration"
...
$t=Get-IsilonListSMBShares -ClusterName $Cluster
